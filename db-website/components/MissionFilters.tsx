...
export interface DatabaseFilters {
	...
	hasBossRush: boolean | null;
	hasBossLoot: boolean | null;
}
...
export function MissionFilters({ filters, onFiltersChange }: MissionFiltersProps) {
	...
	const hasActiveFilters =
		...
		filters.hasBossRush !== null ||
		filters.hasBossLoot !== null;
	...
	return (
		<div className="bg-white dark:bg-zinc-800 rounded-xl shadow-lg p-6">
			...
			<div className="mb-6">
				...
				<div className="flex gap-2">
					<button
						onClick={() => onFiltersChange({ ...filters, hasBossRush: null })}
						className={`flex-1 px-3 py-2 rounded-lg text-sm transition-all ${
							filters.hasBossRush === null
								? 'bg-emerald-600 text-white shadow-md'
								: 'bg-gray-100 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-600'
					...
					<button
						onClick={() => onFiltersChange({ ...filters, hasBossRush: true })}
						className={`flex-1 px-3 py-2 rounded-lg text-sm transition-all ${
							filters.hasBossRush === true
								? 'bg-emerald-600 text-white shadow-md'
								: 'bg-gray-100 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-600'
						}`}
					>
					...
					<button
						onClick={() => onFiltersChange({ ...filters, hasBossRush: false })}
						className={`flex-1 px-3 py-2 rounded-lg text-sm transition-all ${
							filters.hasBossRush === false
								? 'bg-emerald-600 text-white shadow-md'
								: 'bg-gray-100 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-600'
						}`}
					>
			...
			<div className="mb-0">
				...
				<div className="flex gap-2">
					<button
						onClick={() => onFiltersChange({ ...filters, hasBossLoot: null })}
						className={`flex-1 px-3 py-2 rounded-lg text-sm transition-all ${
							filters.hasBossLoot === null
								? 'bg-emerald-600 text-white shadow-md'
								: 'bg-gray-100 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-600'
					...
					<button
						onClick={() => onFiltersChange({ ...filters, hasBossLoot: true })}
						className={`flex-1 px-3 py-2 rounded-lg text-sm transition-all ${
							filters.hasBossLoot === true
								? 'bg-emerald-600 text-white shadow-md'
								: 'bg-gray-100 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-600'
						}`}
					>
					...
					<button
						onClick={() => onFiltersChange({ ...filters, hasBossLoot: false })}
						className={`flex-1 px-3 py-2 rounded-lg text-sm transition-all ${
							filters.hasBossLoot === false
								? 'bg-emerald-600 text-white shadow-md'
								: 'bg-gray-100 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-zinc-600'
						}`}
					>
