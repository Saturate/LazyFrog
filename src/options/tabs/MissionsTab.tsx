    ...
    <div>
      ...
      <div className="grid-3" style={{ marginBottom: '24px' }}>
        <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '20px' }}>
          ...
          <div>
            <div style={{ fontSize: '28px', fontWeight: '700', color: '#e5e5e5', lineHeight: '1' }}>{stats.total}</div>
            <div style={{ fontSize: '13px', color: '#a1a1aa', marginTop: '4px' }}>Total Missions</div>
          </div>
        </div>
        <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '20px' }}>
          <Check size={32} style={{ color: '#22c55e' }} />
          <div>
            <div style={{ fontSize: '28px', fontWeight: '700', color: '#e5e5e5', lineHeight: '1' }}>{stats.cleared}</div>
        ...
        <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '16px', padding: '20px' }}>
          ...
          <div>
            <div style={{ fontSize: '28px', fontWeight: '700', color: '#e5e5e5', lineHeight: '1' }}>{stats.uncleared}</div>
      ...
      <div className="card" style={{ marginBottom: '24px' }}>
        <div style={{ display: 'flex', gap: '12px', marginBottom: '16px', flexWrap: 'wrap' }}>
          ...
          {/* Action buttons */}
          <button onClick={loadMissions} className="button" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <RefreshCw size={16} />
            Refresh
          </button>
          <button onClick={handleImport} className="button" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Upload size={16} />
            Import
          </button>
          <button onClick={handleExport} className="button" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <Download size={16} />
            Export
          </button>
      ...
      <div className="card" style={{ padding: '0', overflow: 'hidden' }}>
        {filteredMissions.length > 0 ? (
          <>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ borderBottom: '1px solid #1a1a1a' }}>
                    ...
                    >
                      Date {sortConfig.field === 'timestamp' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                    </th>
                    <th
                    ...
                    >
                      Mission {sortConfig.field === 'foodName' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                    </th>
                    <th
                    ...
                    >
                      Level {sortConfig.field === 'minLevel' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                    </th>
                    <th
                      style={{
                        padding: '16px',
                    ...
                    >
                      Author {sortConfig.field === 'username' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                    </th>
                    <th
                      style={{
                        padding: '16px',
                ...
                <tbody>
                  {filteredMissions.map((mission) => (
                    ...
                    >
                      <td style={{ padding: '14px 16px', fontSize: '13px', color: '#a1a1aa', whiteSpace: 'nowrap' }}>
                      ...
                      <td style={{ padding: '14px 16px', fontSize: '16px', color: '#eab308' }}>
                        {mission.difficulty ? '★'.repeat(mission.difficulty) : <span style={{ fontSize: '13px', color: '#71717a' }}>N/A</span>}
                      </td>
                      <td style={{ padding: '14px 16px', fontSize: '13px', color: '#e5e5e5', fontWeight: '500' }}>
                        {mission.minLevel && mission.maxLevel ? `${mission.minLevel}-${mission.maxLevel}` : <span style={{ color: '#71717a' }}>N/A</span>}
                      </td>
            ...
            <div style={{ padding: '16px', borderTop: '1px solid #1a1a1a', fontSize: '14px', color: '#71717a' }}>
