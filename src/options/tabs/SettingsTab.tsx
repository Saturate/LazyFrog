...
const SettingsTab: React.FC = () => {
  ...
  const handleClearAllData = async () => {
    if (
      ...
      alert('All data cleared! The extension has been reset to default state. Please reload the extension.');
    }
  };
  ...
  return (
    <div>
      <div className="card">
        <h2>
          <Bug size={20} style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} />
          Debug Settings
        </h2>
        ...
        <div className="form-group" style={{ marginBottom: '20px' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
            <input
              ...
              onChange={(e) => setSettings(prev => ({ ...prev, showStepByStepControls: e.target.checked }))}
              style={{ cursor: 'pointer' }}
            />
            <span>Show Step-by-Step Controls</span>
          </label>
          <p style={{ color: '#a1a1aa', fontSize: '13px', marginTop: '8px', marginLeft: '28px' }}>
        ...
        <div className="form-group">
          <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
            <input
              ...
              onChange={(e) => setSettings(prev => ({ ...prev, remoteLogging: e.target.checked }))}
              style={{ cursor: 'pointer' }}
            />
      ...
      <div className="card">
        <h2>
          <Trash2 size={20} style={{ display: 'inline-block', marginRight: '8px', verticalAlign: 'middle' }} />
          Data Management
        </h2>
        ...
        <div>
          <p style={{ color: '#a1a1aa', fontSize: '14px', marginBottom: '12px' }}>
            Clear all data including missions, settings, and filters. Resets the extension to default state. This action cannot be undone.
          </p>
          <button
            className="button danger"
