	...
	return (
		<div>
			<div className="card">
				...
				<div style={{ marginBottom: '24px' }}>
					<div style={{ fontSize: '14px', color: '#a1a1aa', marginBottom: '8px' }}>
						Version: <span style={{ color: '#e5e5e5', fontWeight: '500' }}>{__VERSION__}</span>
					</div>
			...
			<div className="card">
				...
				<ol style={{ color: '#a1a1aa', lineHeight: '1.8', paddingLeft: '20px' }}>
					<li>
						Configure mission filters in the{' '}
						<strong style={{ color: '#3b82f6' }}>Automation</strong> tab
					</li>
					<li>
						Adjust automation settings in the <strong style={{ color: '#3b82f6' }}>Settings</strong>{' '}
						tab
					</li>
					<li>Visit a Sword & Supper post on Reddit</li>
					<li>
						Click the <strong style={{ color: '#22c55e' }}>START</strong> button in the control
						panel
					</li>
			...
			<div className="card">
				...
				<p style={{ color: '#a1a1aa', fontSize: '14px', lineHeight: '1.6' }}>
					This is an automation tool for educational purposes. Use responsibly and in accordance
					with Reddit's Terms of Service. The developers are not responsible for any consequences of
					using this tool.
				</p>
			</div>
